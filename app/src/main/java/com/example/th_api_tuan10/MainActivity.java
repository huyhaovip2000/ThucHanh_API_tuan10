package com.example.th_api_tuan10;
...
public class MainActivity extends AppCompatActivity {
    ...
    String url = "https://60c03006b8d3670017554719.mockapi.io/Hao";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bntClick.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String urlGet="https://60c03006b8d3670017554719.mockapi.io/Hao";
                GetData(urlGet);
                //GetJson(url);
                //GetArrayJson(url);
                //PostApi(url);
        ...
        btnDel.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String urlDel="https://60c03006b8d3670017554719.mockapi.io/Hao";
                DeleteApi(urlDel);
            }
        });
        btnPut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String urlPost = "https://60c03006b8d3670017554719.mockapi.io/Hao";
                PutApi(urlPost);
            }
        });
    ...
    private void PutApi(String url){
        StringRequest stringRequest = new StringRequest(
                Request.Method.PUT, url + '/' + 7, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                Toast.makeText(MainActivity.this, "Successfully", Toast.LENGTH_SHORT).show();
            }
